...
function convertSourceToOutput(sourceText, includeVideo, divHeight, includeEditable, forSave) {
    ...
    if (includeVideo) {
        ...
        videoPlayerHTML = '<br/><div id="control"><div id="shareRoundIcons"></div><div class="'+$("#txtCategoryName").val()+'" id="ad'+window.currVideoID+'"></div><div id="playerBox"><div class="ui-resizable-handle ui-resizable-se" id="segrip"></div><div id="videoPlayer"></div></div></div>'+htmlInfo;
...
function generateHtmlFromSource() {
    ...
    var jsSocialsJS = '<script src="https://cdn.jsdelivr.net/jquery.jssocials/1.2.1/jssocials.min.js"></script>';
    var jsSocialsCSS = '<script type="text/javascript" src="https://cdn.jsdelivr.net/jquery.jssocials/1.2.1/jssocials.min.js"></script><link type="text/css" rel="stylesheet" href="https://cdn.jsdelivr.net/jquery.jssocials/1.2.1/jssocials.css" /><link type="text/css" rel="stylesheet" href="https://cdn.jsdelivr.net/jquery.jssocials/1.2.1/jssocials-theme-classic.css" />';
    ...
    var segripStyle = '<style>#segrip {width: 10px;height: 10px;background-color: #ffffff;border: 1px solid #000000;bottom: -5px;right: -5px;}</style>';
    var head = '<head>' + title +jsSocialsCSS+ bootstrapScript + mathjaxScript + jqueryUiScript+ playerScript+jsSocialsJS+ analyticsScript+segripStyle+'</head>';
