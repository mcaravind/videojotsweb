...
function convertSourceToOutput(sourceText, includeVideo, divHeight, includeEditable, forSave) {
    ...
    if (includeVideo) {
        ...
        videoPlayerHTML = '<br/><div id="control"><div id="divShare"></div><div class="'+$("#txtCategoryName").val()+'" id="ad'+window.currVideoID+'"></div><div id="playerBox"><div class="ui-resizable-handle ui-resizable-se" id="segrip"></div><div id="videoPlayer"></div></div></div>'+htmlInfo;
...
function generateHtmlFromSource() {
    ...
    var head = '<head>' + title + bootstrapScript + mathjaxScript + jqueryUiScript+ playerScript+ analyticsScript+segripStyle+'</head>';
